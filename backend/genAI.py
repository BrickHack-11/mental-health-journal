...
def get_self_care_suggestion(age, gender, contri, mood, journal_entry):
    pre_prompt = 'Here is the journal entry of a ' + str(age) + ' year old ' + str(gender) + ' their mood was ' + str(mood) + ' today and it was due to ' + str(contri) + ' :' 
